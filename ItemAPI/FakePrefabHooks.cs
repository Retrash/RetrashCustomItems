...
namespace ItemAPI
{
    ...
    public static class FakePrefabHooks
    {
        ...
        {
            Hook hook = new Hook(typeof(PlayerController).GetMethod("AcquirePassiveItemPrefabDirectly"), typeof(FakePrefabHooks).GetMethod("AcquirePassiveItemPrefabDirectly"));
            Hook hook2 = new Hook(typeof(PlayerItem).GetMethod("Pickup"), typeof(FakePrefabHooks).GetMethod("ActivePickup"));
